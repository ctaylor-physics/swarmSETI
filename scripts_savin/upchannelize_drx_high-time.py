...
tar_path = '/data/network/recent_data/savin/alltar/DD002_8099*.tgz'
...
for tarball in tarballs:
    ...
    if tarball_base in metafiles1:
        ...
        if os.path.exists(datafile_path):
            cmd1 = f'/usr/local/extensions/Commissioning/DRX/HDF5/hdfWaterfall.py -a 0.2 -l 4096 -m {tarball} -k {datafile_path}'
            os.system(cmd1)
